...
public final class DocumentUtils {
   ...
   * ending punctuation <code>., ?, and !</code>.
   * <p>
   * Furthermore, it also gives the option to break a sentence into 2 clauses if
   * the sentence satisfies two conditions. First, it contains a co-ordinating
   * conjunction (we only consider <code>and</code> and <code>but</code> because
   * of their frequency). Second, each of the 2 parts of the sentence divided by
   * the conjunction must contain at least one pair of sentiment and aspect
   * word, i.e., an adjective and a noun. The original sentence is then
   * considered as two sentences.
   * <p>
   ...
   * @param divideSentenceByConjunction
   *          true to divide sentence by conjunctions
   * @return
   */
  ...
  /**
   * Tokenizes and stems the given text segment <code>text</code> using the
   * provided tokenizer and stemmer.
   * 
   * @param text
   * @return
   */
  public static String[] tokenizeAndStem(String text, TokenizerFactory tokenizer,
