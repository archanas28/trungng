...
public class Utils {
  ...
  public static void readNetworkStat(String networkStatFile,
      List<String> networkHeader, HashMap<String, List<Double>> networkMap)
      throws Exception {
  ...
  public static void readTopicStat(String topicStatFile,
      List<String> topicHeader, HashMap<String, List<Double>> topicMap)
      throws Exception {
    BufferedReader in = new BufferedReader(new FileReader(new File(
        topicStatFile)));
  ...
  public static void readNodeFile(String nodeFile,
      HashMap<String, Calendar> nodeTimeMap, HashMap<String, String> nodeMap)
      throws Exception {
  ...
  public static void readLinkFile(String linkFile, List<String> sources,
      List<String> targets, HashMap<String, List<String>> neighborMap)
      throws Exception {
  ...
  public static void readImpactStat(String impactWidthFile,
      String impactDepthFile, String impactSizeFile,
      HashMap<String, List<Double>> impactMap) throws Exception {
    BufferedReader inWidth = new BufferedReader(new FileReader(new File(
        impactWidthFile)));
    BufferedReader inDepth = new BufferedReader(new FileReader(new File(
        impactDepthFile)));
    BufferedReader inSize = new BufferedReader(new FileReader(new File(
        impactSizeFile)));
  ...
  public static Vector<String> makeVectorFromFile(String fileName)
      throws Exception {
  ...
  public static Vector<String> makeStemmedVectorFromFile(String fileName,
      boolean usingStemmer) throws Exception {
    Vector<String> list = new Vector<String>();
    String line;
    BufferedReader reader = new BufferedReader(new InputStreamReader(
        new FileInputStream(fileName)));
  ...
  public static Vector<String> makeStemmedValidWordFromFile(String fileName,
      boolean usingStemmer) throws Exception {
