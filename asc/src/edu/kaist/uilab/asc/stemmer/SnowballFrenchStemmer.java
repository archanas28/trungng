...
public class SnowballFrenchStemmer extends SnowballStemmer {

  private static final long serialVersionUID = 1L;

  private final static SnowballFrenchStemmer methodObject = new SnowballFrenchStemmer();
  ...
  private void copy_from(SnowballFrenchStemmer other) {
    I_p2 = other.I_p2;
    I_p1 = other.I_p1;
    I_pV = other.I_pV;
  ...
  public boolean equals(Object o) {
    return o instanceof SnowballFrenchStemmer;
  }

  public int hashCode() {
    return SnowballFrenchStemmer.class.getName().hashCode();
  }
