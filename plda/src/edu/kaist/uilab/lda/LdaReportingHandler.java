...
public class LdaReportingHandler implements
   ...
   * 
   * @param symbolTable
   *       the symbol table used in the sampling
   */
   ...
   * @param reportTokens
   */
  public void fullReport(LatentDirichletAllocation.GibbsSample sample, String file,
    ...
    try {
      ...
      for (int topic = 0; topic < numTopics; ++topic) {
        ...
        for (int word = 0; word < numWords; ++word)
          counter
              .set(Integer.valueOf(word), sample.topicWordCount(topic, word));
  ...
  public void handle(GibbsSample e) {
    System.out.printf("Collected a sample at epoch %d: likelihood=%.7f\n",
        e.epoch(), e.corpusLog2Probability());
  }
}