...
package com.lingp.jppodcast.musicplayer;
...
public class MusicIntentReceiver extends BroadcastReceiver {
  ...
  public void onReceive(Context context, Intent intent) {
    if (intent.getAction().equals(
      ...
      Toast.makeText(context, "Headphones disconnected.", Toast.LENGTH_SHORT)
          .show();
      ...
      case KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE:
        context.startService(new Intent(Strings.ACTION_TOGGLE_PLAYBACK));
        break;
      ...
      case KeyEvent.KEYCODE_MEDIA_STOP:
        context.startService(new Intent(Strings.ACTION_STOP));
        break;
      }
    }
  }
