...
public class CoursesActivity extends ListActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (userId != Constants.INVALID_ID) {
      ...
      mAdapter = new CourseListAdapter(CoursesActivity.this,
      ...
      if (mAdapter != null) {
        ...
        Toast.makeText(CoursesActivity.this, "Cannot get data from server",
            Toast.LENGTH_SHORT).show();
      }
    } else {
      UIUtils.goLogin(CoursesActivity.this);
    }
  }
  ...
  private ArrayList<FileMsg> getCourses(long userId) {
    UrlBuilder builder = new UrlBuilder(RESOURCE_URL + userId + "/courses");
