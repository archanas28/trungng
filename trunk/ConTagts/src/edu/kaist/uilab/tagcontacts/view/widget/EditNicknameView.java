...
/**
 * Activity for adding new nickname for a contact.
 * 
 * @author Trung Nguyen (trung.ngvan@gmail.com)
 *
 */
public class EditNicknameView extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.new_nickname);
		...
		mTxt1 = (EditText) findViewById(R.id.txt_nickname);
		...
		if (oldTxt1 != null) { // edit
			...
			bar.setText(R.string.title_edit_nickname);
			mTxt1.setText(oldTxt1);
		} else { // add
			bar.setText(R.string.title_add_nickname);
		}	
		...
		mSaveBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.putExtra(Constants.INTENT_INT_REQUEST_CODE,
						NewContactView.EDIT_NICKNAME_REQUEST);
