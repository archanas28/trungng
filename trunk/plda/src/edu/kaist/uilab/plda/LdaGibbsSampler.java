...
public class LdaGibbsSampler {
   ...
   * Select an element 2. Update conditional on other elements. If appropriate,
   * output summary for each run.
   * 
   * @param K
   *          number of topics
   * @param alpha
  ...
  private void gibbs(int K, double alpha, double beta) {
    ...
    System.out.println("Sampling " + ITERATIONS
        + " iterations with burn-in of " + BURN_IN + " (B/S=" + THIN_INTERVAL
        + ").");
   ...
   * mean value of all sampled statistics for theta[][] is taken.
   * 
